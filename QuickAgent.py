...
def tavily_search(query):
    search_result = tavily_client.get_search_context(query, search_depth="advanced", max_tokens=10000)
    return search_result
query = input("WEBSITE URL: ")
WEBSITE_URL = tavily_search(query=query)
...
# library.save("faiss_index")

# #User Input for Query
# Query1 = input("Enter User Query")

# Query_Answer = library.similarity_search(Query1)
# print(f"Query Answer: {Query_Answer}")

# BEHAVIOUR_OPTION = [Friendly, Sweet]
# BEHAVIOUR_STYLE = BEHAVIOUR_OPTION[0]
# print(f"This is the Behaviour {BEHAVIOUR_STYLE}")
...
class LanguageModelProcessor:
    ...
    def __init__(self):
        ...
        # self.llm = OpenAIAssistantRunnable.create_assistant(
        #     name= "AI_Advisor_Name",
        #     instructions= "Need to Add A placeHolder for Instructions",
        #     tools= [{"type": "code_interpreter"}],
        #     model= "gpt-4o-mini",
        # )


        ##NOTE TO ADD ASSISTANT VERSION
